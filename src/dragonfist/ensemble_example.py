...
from attacks import attackFGM, attackJSM
...
def main(train):
    ...
    attackJSM(claw1, dataset, ensemble=ensemble)
    attackJSM(claw2, dataset, ensemble=ensemble)
    attackJSM(claw3, dataset, ensemble=ensemble)
